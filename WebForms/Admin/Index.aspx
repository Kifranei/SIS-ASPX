        ...
        <div class="panel panel-info">
            ...
            <div class="panel-body">
                <ul class="list-group">
                    ...
                    <li class="list-group-item"><strong>已运行时长:</strong> <%= string.Format("{0}天 {1:00}:{2:00}:{3:00}", RunningTime.Days, RunningTime.Hours, RunningTime.Minutes, RunningTime.Seconds) %></li>
                </ul>
            </div>
        </div>
    </div>
