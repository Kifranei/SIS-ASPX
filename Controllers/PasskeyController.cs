        ...
        public async Task<ActionResult> MakeAssertion()
        {
            try
            {
                ...
                if (referer.IndexOf("/WebForms/", StringComparison.OrdinalIgnoreCase) >= 0 ||
                    referer.EndsWith("/Login.aspx", StringComparison.OrdinalIgnoreCase) ||
                    (referer.StartsWith("/Admin/", StringComparison.OrdinalIgnoreCase) && referer.EndsWith(".aspx", StringComparison.OrdinalIgnoreCase)) ||
                    (referer.StartsWith("/Teacher/", StringComparison.OrdinalIgnoreCase) && referer.EndsWith(".aspx", StringComparison.OrdinalIgnoreCase)) ||
                    (referer.StartsWith("/Student/", StringComparison.OrdinalIgnoreCase) && referer.EndsWith(".aspx", StringComparison.OrdinalIgnoreCase)))
                {
                    useWebForms = true;
                }
                ...
                if (useWebForms)
                {
                    if (user.Role == 0) redirectUrl = "/Admin/Index.aspx";
                    else if (user.Role == 1) redirectUrl = "/Teacher/Index.aspx";
                    else redirectUrl = "/Student/Index.aspx";
                }
                else
                {
